...
# --- MAIN APP LOGIC ---
if check_password():
    # EVERYTHING below this line is indented 4 spaces
    # This ensures it ONLY runs after a successful login
    
    st.title("🏆 Private League Dashboard")
    
    # Use the secret ID from your secrets.toml
